...
|----------|------|---------|
| `getting_started/01_project_overview.md` | `web/PROJECT_OVERVIEW.html` | Project intro |
| `core_guides/technical/backend_guide.md` | `web/backend_guide.html` | API documentation |
| `hardware/architecture/hardware_architecture.md` | `web/hardware_architecture.html` | Hardware specs |
| `technical_reference/specs/api_reference.md` | `web/api_reference.html` | API endpoints |
| ... | ... | ... |
