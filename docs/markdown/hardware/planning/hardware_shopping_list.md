...
| 3 | **DHT11 Temperature & Humidity Sensor** | AM2302, Digital output | 1 | $3-5 | Measure air temp & humidity |
...
**Recommendation:** Your system is using the DHT11. It is less accurate but sufficient for local monitoring.
...
2. Test DHT11: Read temperature/humidity
...
3. Add DHT11 with connections
4. Add soil moisture sensor
5. Add relay module
6. Connect pump to relay output

### Step 3: Software Upload
1. Install Arduino IDE 2.x (see [hardware_setup.md](../guides/hardware_setup.md))
...
- ESP32 + DHT11 + Soil Sensor + Relay Kit: $15-20
- Water pump: $3-5
...
- DHT11: DHT11 (cheaper, less accurate)
