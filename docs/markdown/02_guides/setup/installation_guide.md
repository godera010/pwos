...
See [MQTT Topics Reference](../reference/mqtt_topics.md) for full details.
...
2. **Understand the ML model** — see [ML Model Guide](ml_model_guide.md)
3. **Explore the database** — see [Database Guide](database_guide.md)
4. **Debug MQTT** — see [MQTT Topics Reference](../reference/mqtt_topics.md)
5. **Mobile Setup & Guide** — see [Mobile App Guide](mobile_guide.md)
