...
graph TB
    subgraph "Local Machine (localhost)"
        ...
        ML["🧠 ML Predictor (Crop-Aware)<br/><i>rf_model.pkl</i><br/>12 features / 630k samples"]
        DB["🗄️ PostgreSQL (Pooled)<br/>Port: 5432"]
        FE["🖥️ React Dashboard<br/><i>Vite dev server</i><br/>Port: 5173<br/>(Dashboard | CropSettings | MLInsights)"]
    end
...
graph TB
    ...
    subgraph "Client"
        DASH["🖥️ React Web Dashboard<br/><i>Vercel / Netlify</i>"]
        MOBILE["📱 Mobile App<br/><i>React Native / Expo</i>"]
    end
...
| ML Accuracy | ≥75% | **83.43%** (multi-crop) | ✅ Exceeded |
| F1-Score | ≥0.75 | **0.82** | ✅ Exceeded |
| Crop Support | 1 (soil-only) | **5 crops** | ✅ Enhanced |
| Region Support | 1 | **3 Zimbabwe regions** | ✅ Enhanced |
| Test Suite | — | **116 / 116** ✅ | ✅ All Passing |
