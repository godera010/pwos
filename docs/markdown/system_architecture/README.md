...
|---|---|
| [**06_summary.md**](../getting_started/06_summary.md) | **The Definitive Full-Stack Engine Manual** |
...
| Document | What it answers |
|---|---|
| [07_architecture.md](../getting_started/07_architecture.md) | System modes, the 5-second control loop, state machine, 4 output actions |
...
| [ml_model_deep_dive.md](../ml/ml_model_deep_dive.md) | What the model predicts, feature roles, Decision Engine state machine |
...
1. **`06_summary.md`** — The high-level encyclopedia
2. **`07_architecture.md`** — understand the big picture and control loop
