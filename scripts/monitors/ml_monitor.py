...
class MLMonitor:
    def __init__(self):
        ...
        # Get project root (2 levels up from scripts/monitors/ml_monitor.py)
    ...
    def print_row(self, inputs, output):
        ...
        color = GREEN
        color = GREEN
        if decision == "NOW": color = RED
        elif decision == "STOP": color = RED
        elif decision == "STALL": color = YELLOW
        elif decision == "MONITOR": color = GREEN
