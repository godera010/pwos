...
# Get project root (3 levels up from scripts/analysis/live_weather_dashboard.py)
...
try:
    ...
    pass # Handle case where it might be created concurrently
...
def print_dashboard():
    ...
    while True:
        try:
            ...
            print("--------------------------------------------------")
            print(f"   {weather_icon}  Condition:    {'RAIN EXPECTED' if rain_minutes > 0 else 'CLEAR / CLOUDY'}")
